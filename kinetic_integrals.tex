...
as
\begin{equation}
    I_{\bw}^{l,q}(\bu)=\int\dd{\bw}w^l\pqty{\bw\vdot\bu}^q\exp\pqty{-Bw^2}
    \exp\pqty{R\bw\vdot\bu},\quad q=\Bqty{0,1}.
\end{equation}

Again, we can start by solving for a simpler case $q=0$.
